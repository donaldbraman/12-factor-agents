...
'''
            ...
            # Run pytest
            cmd = ["uv", "run", "python", "-m", "pytest", str(test_path), "-v", "--tb=short"]
...
class TestingAgent(BaseAgent):
    ...
    def execute_task(self, task: str) -> ToolResponse:
        ...
        if lint_result.success:
            print(f"✅ Lint check passed - {lint_result.data['files_checked']} files checked")
        else:
        ...
        if unit_result.success:
            print(f"✅ Unit tests passed - {unit_result.data['passed']}/{unit_result.data['tests_run']} passed")
        else:
        ...
        if integration_result.success:
            print(f"✅ Integration tests passed - {integration_result.data['passed']}/{integration_result.data['tests_run']} passed")
        else:
            print(f"❌ Integration tests failed - {integration_result.data['failed']} failures")
            all_passed = False
        ...
        print(f"  Unit Tests: {all_results['unit_tests']['passed']}/{all_results['unit_tests']['tests_run']} passed")
        print(f"  Integration Tests: {all_results['integration_tests']['passed']}/{all_results['integration_tests']['tests_run']} passed")
