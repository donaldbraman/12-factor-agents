#!/usr/bin/env python3
"""
Sparky PR Agent - Wrapper for AsyncSparky with PR workflow
...
class SparkyPRAgent:
    ...
    def process_issue(self, issue_file: str) -> ToolResponse:
        ...
        try:
            ...
            # Step 2: Process the issue using existing AsyncSparky
...
**Agent**: AsyncSparky via SparkyPRAgent"""
