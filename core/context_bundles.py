...
class ContextBundleManager:
    ...
    def append_action(self, action_type: ActionType, action_data: Dict[str, Any], 
    ...
    def create_checkpoint(self, phase: str, progress: float, 
    ...
    def get_action_history(self, action_type: ActionType = None, 
                          limit: int = None) -> List[TimestampedAction]:
        """
        Get action history
    ...
    def get_bundle_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "latest_checkpoint": self.get_latest_checkpoint().checkpoint_id if self.checkpoints else None
        }
                    ...
                    if session_path.is_dir():
                        ...
                        if bundle_file.exists():
                            age_hours = (datetime.now() - datetime.fromtimestamp(
                                bundle_file.stat().st_mtime)).total_seconds() / 3600
...
class BundleEnabledAgent(BaseAgent):
    ...
    async def create_handoff(self, target_agent_id: str, 
    ...
    def get_handoff_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "state_summary": {
                k: type(v).__name__ for k, v in self.bundle_manager.current_state.items()
            },
