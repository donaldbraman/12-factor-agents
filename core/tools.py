    ...
    def __call__(self, **kwargs) -> ToolResponse:
        ...
        try:
            ...
            return ToolResponse(
                success=False,
                error=str(e),
                metadata={"tool_name": self.name, "call_count": self.call_count},
            )
...
class FileTool(Tool):
    ...
    def __init__(self):
        super().__init__(
            name="file_tool", description="Read, write, and manipulate files"
        )
    ...
    def execute(
        ...
        try:
            if operation == "read":
                ...
                return ToolResponse(
                    success=True,
                    data={"path": str(file_path), "exists": file_path.exists()},
                )
...
class HumanInteractionTool(Tool):
    ...
    def __init__(self):
        super().__init__(
            name="human_interaction", description="Request human input or approval"
        )
    ...
    def execute(
        ...
        # Timeout
        return ToolResponse(
            success=False, error=f"Human response timeout after {timeout} seconds"
        )
    ...
    def get_parameters_schema(self) -> Dict[str, Any]:
        return {
            ...
            "properties": {
                ...
                "message": {"type": "string", "description": "Message to human"},
