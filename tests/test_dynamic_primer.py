...
class TestDynamicContextPrimer:
    ...
    def test_research_primer(self):
        ...
        variables = {
            ...
            'domain': 'Web Security',
            'research_questions': ['Which framework is most secure?', 'Performance comparison'],
    ...
    def test_optimization_primer(self):
        ...
        variables = {
            ...
            'current_metrics': {'avg_response_time': '500ms', 'queries_per_request': '15'}
        }
    ...
    async def test_concurrent_primer_generation(self):
        ...
        tasks = [
            generate_primer('feature_development', i) 
            for i in range(5)
        ]
