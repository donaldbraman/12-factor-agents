...
class TestContextOptimizer:
    ...
    def test_delegation_triggered_at_threshold(self, optimizer):
        ...
        assert result.delegated_tasks[0]["recommended_agent"] in [
            "ImplementationAgent", "GeneralPurposeAgent"
        ]
    ...
    def test_relevance_checking(self, optimizer):
        ...
        assert optimizer.is_relevant_to_task("requirements", "any", keywords)  # Core item
    ...
    def test_agent_recommendation(self, optimizer):
        ...
        assert optimizer.recommend_agent_type("implement feature") == "ImplementationAgent"
...
class TestRDFrameworkIntegration:
    ...
    def test_end_to_end_optimization(self):
        ...
        context = {
            "project_description": "Build a comprehensive e-commerce platform with user authentication, " * 10,
            "requirements": [
            ...
            "conversation_history": [f"Message {i}: Discussion about feature {i}" for i in range(50)],
