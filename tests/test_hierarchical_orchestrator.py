...
class TestTaskDecomposer:
    ...
    def test_level_determination(self):
        ...
        assert decomposer._determine_level(TaskComplexity.SIMPLE, 0) == OrchestrationLevel.PRIMARY
        assert decomposer._determine_level(TaskComplexity.COMPLEX, 1) == OrchestrationLevel.SECONDARY
        assert decomposer._determine_level(TaskComplexity.MODERATE, 2) == OrchestrationLevel.TERTIARY
...
class TestWorkloadDistributor:
    ...
    def test_round_robin_distribution(self):
        ...
        tasks = [
            OrchestrationTask("1", "task1", OrchestrationLevel.SECONDARY, TaskComplexity.SIMPLE),
            OrchestrationTask("2", "task2", OrchestrationLevel.SECONDARY, TaskComplexity.SIMPLE),
            OrchestrationTask("3", "task3", OrchestrationLevel.SECONDARY, TaskComplexity.SIMPLE)
        ]
    ...
    def test_capability_based_distribution(self):
        ...
        tasks = [
            OrchestrationTask("1", "database task", OrchestrationLevel.SECONDARY, TaskComplexity.SIMPLE),
            OrchestrationTask("2", "api task", OrchestrationLevel.SECONDARY, TaskComplexity.SIMPLE)
        ]
        
        agents = [
            AgentInfo("agent1", OrchestrationLevel.SECONDARY, specializations=["database", "sql"]),
            AgentInfo("agent2", OrchestrationLevel.SECONDARY, specializations=["api", "rest"])
        ]
    ...
    def test_distribute_with_strategy(self):
        ...
        tasks = [OrchestrationTask("1", "task", OrchestrationLevel.SECONDARY, TaskComplexity.SIMPLE)]
...
class TestHierarchicalOrchestrator:
    ...
    def test_initialization_with_custom_params(self):
        ...
        orchestrator = HierarchicalOrchestrator(
            max_depth=4, 
            max_agents_per_level=custom_limits
        )
    ...
    async def test_complex_task_orchestration(self):
        ...
        complex_task = "Implement complete OAuth2 authentication system with multiple providers"
    ...
    async def test_orchestration_cancellation(self):
        ...
        orchestrator.agents["test-agent"] = AgentInfo("test-agent", OrchestrationLevel.SECONDARY)
        orchestrator.tasks["test-task"] = OrchestrationTask(
            "test-task", "Test task", OrchestrationLevel.SECONDARY, TaskComplexity.SIMPLE
        )
